...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-padding relative">
      <div className="absolute inset-0 bg-gradient-to-t from-neon-cyan/3 to-transparent pointer-events-none" />
      ...
      <div ref={ref} className="max-w-3xl mx-auto relative z-10 text-center">
        ...
        >
          <h2 className="font-[Orbitron] text-3xl sm:text-4xl font-bold mb-2">
            <span className="text-neon-cyan/40 text-lg mr-2 font-mono">05.</span>
        ...
        <motion.p
          ...
          className="text-text-muted mt-6 mb-8 max-w-md mx-auto leading-relaxed"
        >
          I'm always open to discussing AI/ML opportunities, research collaborations, or interesting data challenges. Let's build something impactful together.
        </motion.p>
        ...
        >
          <MapPin size={14} className="text-neon-cyan/50" />
        ...
        >
          {socials.map(({ icon: Icon, label, href }) => (
            <a
              ...
              className="group flex items-center gap-2.5 px-5 py-3 glass rounded-xl border border-white/5 hover:border-neon-cyan/30 hover:bg-neon-cyan/5 transition-all duration-300"
            >
              ...
              <ArrowUpRight size={14} className="text-text-muted/40 group-hover:text-neon-cyan/60 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
            </a>
          ))}
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="absolute inset-0 bg-gradient-to-r from-neon-cyan to-neon-purple blur-xl opacity-30 group-hover:opacity-50 transition-opacity" />
            <Mail size={16} className="relative text-surface-dark" />
            <span className="relative text-surface-dark font-bold tracking-wide">Say Hello</span>
          </a>
        </motion.div>
      </div>
    </section>
