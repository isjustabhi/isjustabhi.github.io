...
const barColors = [
  ...
  'from-neon-purple to-neon-purple/60',
  'from-neon-pink to-neon-pink/60',
  'from-neon-green to-neon-green/60',
];
...
function SkillCategory({ category, catIndex }) {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-2xl p-6 gradient-border group hover:bg-white/[0.02] transition-colors duration-300"
    >
          ...
          <div key={skill.name}>
            ...
            <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
              <motion.div
                ...
                style={{
                  boxShadow: inView ? `0 0 8px rgba(0, 240, 255, 0.3)` : 'none',
                }}
              />
            </div>
          </div>
